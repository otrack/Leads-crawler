package eu.leads.crawler.samples;

import eu.leads.crawler.CrawlerConfiguration;
import eu.leads.crawler.CrawlerController;
import eu.leads.crawler.CrawlerException;
...
public class TestSimpleSample {
    ...
    public static void main(String[] args) throws MalformedURLException, CrawlerException {
        ...
        crawlerController.join(10000);
        System.out.println(new Date() + "Stopping crawler");
        crawlerController.stop();
    }

    /**
     * Custom crawler. Extends {@link eu.leads.crawler.DefaultCrawler}.
     */
